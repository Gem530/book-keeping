				...
				<view class="bill-left">
					...
					<view class="bill-left-type">
						...
						<view class="bill-type-progress">
							<view class="bill-type-progress-bar" :style="{width: getCurPer(item.value)+'%', background: item.amountType.color || $store.getters.primaryColorLive + ' !important'}"></view>
						</view>
					</view>
				</view>
...
<script>
	...
	import LineChart from '@/component/echart/echart.vue'
	import PieChart from '@/component/echart/pie-echart.vue'
		...
		.params-item {
			...
			&:not(:last-child) {
				&::after {
					...
					right: 0;
					height: 100%;
					border-right: 1rpx solid var(--theme-gray);
				}
			}
